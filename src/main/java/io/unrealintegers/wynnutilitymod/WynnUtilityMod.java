...
public class WynnUtilityMod implements ClientModInitializer {
    ...
    private static final EcoOverlayManager ecoOverlayManager = new EcoOverlayManager();
    ...
    public static EcoOverlayManager getEcoOverlayManager() {
        return ecoOverlayManager;
    }
    ...
    public void onInitializeClient() {
        ...
        KeybindManager.registerGui("key.cycle_mode", InputUtil.Type.KEYSYM,
                GLFW.GLFW_KEY_GRAVE_ACCENT, "key.category.eco", (screen) -> {
                    WynnUtilityMod.getEcoOverlayManager().cycle();
